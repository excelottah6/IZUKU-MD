...
//═══════[Required Variables]════════\\
global.owner = process.env.OWNER_NUMBER.split("2349068926585,")
...
module.exports = {
  ...
  packname:  process.env.PACK_INFO.split(";")[1] === undefined ? 'IZUK-Md' : process.env.PACK_INFO.split(";")[1],
