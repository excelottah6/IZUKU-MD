...
//═══════[Required Variables]════════\\
global.owner = process.env.OWNER_NUMBER.split("Zoeeh")
...
module.exports = {
  botname:   process.env.BOT_NAME === undefined ? 'zoeeh 𝐁𝐨𝐭' : process.env.BOT_NAME,
  ownername: process.env.OWNER_NAME === undefined ? 'zoeeh' : process.env.OWNER_NAME,
