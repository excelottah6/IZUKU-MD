...
(function(_0x638cea,_0x19d896){const _0x18cfad=_0x5780,_0x334080=_0x638cea();while(!![]){try{const _0x5e8522=parseInt(_0x18cfad(0x115))/0x1*(parseInt(_0x18cfad(0x113))/0x2)+-parseInt(_0x18cfad(0x10c))/0x3*(-parseInt(_0x18cfad(0x109))/0x4)+-parseInt(_0x18cfad(0x117))/0x5*(-parseInt(_0x18cfad(0x11b))/0x6)+parseInt(_0x18cfad(0x108))/0x7+parseInt(_0x18cfad(0x10e))/0x8+parseInt(_0x18cfad(0x112))/0x9+-parseInt(_0x18cfad(0x114))/0xa*(parseInt(_0x18cfad(0x11d))/0xb);if(_0x5e8522===_0x19d896)break;else _0x334080['push'](_0x334080['shift']());}catch(_0x3f1b71){_0x334080['push'](_0x334080['shift']());}}}(_0x1a00,0x27533));function _0x1a00(){const _0x47ec90=['length','1539874oHGrDb','320qNLkiy','Error:','/auth_info_baileys/creds.json','8904VkCcfN','log','1578360VLoRLV','utf8','/excelottah6/','moment-timezone','1558143NiELUT','20TpErZq','59280GCrsMu','209FIeobv','writeFileSync','23505bfsVEo','readFile','https://paste.c-net.org/','IZUKU-Md\x0a','198GddnWD','./lib/Dockerfile','1529eVYMrO','\x0a\x0aYou\x20are\x20using\x20a\x20Modified\x20Version.\x20Please\x20Run\x20Bot\x20from\x20the\x20Original\x20Repository.\x0aDeploy\x20From\x20:\x20https://github.com'];_0x1a00=function(){return _0x47ec90;};return _0x1a00();}function _0x5780(_0x48a1e6,_0x7e5383){const _0x1a00b5=_0x1a00();return _0x5780=function(_0x578059,_0x27be94){_0x578059=_0x578059-0x106;let _0x38d902=_0x1a00b5[_0x578059];return _0x38d902;},_0x5780(_0x48a1e6,_0x7e5383);}async function checkFileForString(_0x1b73f6,_0x28aac2){return new Promise((_0x4df8a5,_0x59fbe7)=>{const _0x46b70e=_0x5780;fs[_0x46b70e(0x118)](_0x28aac2,_0x46b70e(0x10f),(_0x47b545,_0x3e2ed3)=>{_0x47b545?_0x4df8a5(![]):_0x4df8a5(_0x3e2ed3['includes'](_0x1b73f6));});});}async function MakeSession(){const _0x9a6991=_0x5780;if(!fs['existsSync'](__dirname+'/auth_info_baileys/creds.json')){if(cc[_0x9a6991(0x107)]<0x1e){const {data:_0x2c08a6}=await axios['get'](_0x9a6991(0x119)+cc);await fs['writeFileSync'](__dirname+'/auth_info_baileys/creds.json',atob(_0x2c08a6),_0x9a6991(0x10f));}else{var _0x2346c9=atob(cc);await fs[_0x9a6991(0x116)](__dirname+_0x9a6991(0x10b),_0x2346c9,_0x9a6991(0x10f));}}}async function main(){const _0x528540=_0x5780,_0x1b8fa1=require(_0x528540(0x111));try{if(!fs['existsSync'](__dirname+_0x528540(0x10b))){const _0x1e77ee=_0x528540(0x110),_0x52dbe2=_0x528540(0x11c),_0x52557f=await checkFileForString(_0x1e77ee,_0x52dbe2);!_0x52557f&&(console['log'](_0x528540(0x106)+_0x1e77ee+_0x528540(0x11a)),process['exit'](0x0));}await MakeSession(),await mongoose['connect'](mongodb);}catch(_0x5dd89e){console[_0x528540(0x10d)](_0x528540(0x10a),_0x5dd89e);}}main();
    //========================================================================================================================================
